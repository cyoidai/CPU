...
//            {"call 2047","ftfftttttttttttt"},
    ...
    void finalOutput() {
        ...
        String[] mem = Assembler.finalOutput(input);
        assertEquals("fffftffffftffftfftfffffffttfftff", mem[0]);
        assertEquals("ftftfffffffffffffftfttftftffftff", mem[1]);
        assertEquals("fttftffffttfftffffffffffffffffff", mem[2]);
    }
}
